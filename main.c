...
int main()
{
    ...
    register_task(30000, task_led);   // 80초  - LED 패턴 변경
    register_task(30000, task_fnd);   // 60초  - FND 숫자 증가
    register_task(30000, task_dot);   // 40초  - DOT 패턴 변경
    register_task(30000, task_motor);   // 100초 - LCD 틱 표시
    register_task(30000, task_lcd); // 50초  - 모터 제어 (새로 추가)
